...
public class ModFile implements
    ...
    public static Color characterColor = new Color(0.855f, 0.235f, 0.341f, 1);
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new CharacterFile(CharacterFile.characterStrings.NAMES[1], CharacterFile.Enums.THE_UMA),
            CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, CharacterFile.Enums.THE_UMA);
