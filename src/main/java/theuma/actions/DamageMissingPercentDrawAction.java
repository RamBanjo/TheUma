...
public class DamageMissingPercentDrawAction extends AbstractGameAction {
    ...
    public DamageMissingPercentDrawAction(AbstractCreature target, DamageInfo info, int missingThreshold) {
        this.info = info;
    ...
    public void update() {
        if (this.shouldCancelAction()) {
            ...
            if (this.isDone) {
                ...
                att(new DrawCardAction(thresholdsPassed));
