...
public class ConditionalScryAction extends AbstractGameAction {
    private static final UIStrings uiStrings;
    public static final String[] TEXT;
    private float startingDuration;

    private Predicate<AbstractCard> pred;
    private ArrayList<AbstractGameAction> actionsIfPredPasses;

    public ConditionalScryAction(int numCards, Predicate<AbstractCard> pred, AbstractGameAction... acts) {
        ...
        this.actionsIfPredPasses = new ArrayList<>();
        actionsIfPredPasses.addAll(Arrays.asList(acts));
        ...
        if (AbstractDungeon.getMonsters().areMonstersBasicallyDead()) {
            ...
            if (this.duration == this.startingDuration) {
                ...
                for(AbstractCard c : AbstractDungeon.gridSelectScreen.selectedCards) {
                    ...
                    if(pred.test(c)){
                        for(AbstractGameAction a : actionsIfPredPasses){
                            addToBot(a);
                        }
                    }
                }
