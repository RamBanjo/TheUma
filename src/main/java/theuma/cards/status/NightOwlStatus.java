...
public class NightOwlStatus extends AbstractEasyCard {
    public final static String ID = makeID("NightOwlStatus");
    ...
    public void onRetained() {
        ...
        //Cards that are valid are in our draw pile and have a cost of 0 or greater (which can be modified)
        List<AbstractCard> validCardsInHand = AbstractDungeon.player.drawPile.group.stream().filter(
            c -> c.cost >= 0
